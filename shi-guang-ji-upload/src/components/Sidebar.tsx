...
const navItems = [
  ...
  { key: "anniversary", label: "纪念日", href: "/anniversary", icon: HeartIcon },
  { key: "calendar", label: "日历", href: "/calendar", icon: CalendarIcon },
  { key: "gallery", label: "图库", href: "/gallery", icon: ImageIcon },
  { key: "recycle-bin", label: "回收站", href: "/recycle-bin", icon: TrashIcon },
  { key: "chat", label: "聊天", href: "/chat", icon: MessageIcon },
  { key: "diary", label: "日记", href: "/diary", icon: BookIcon },
  { key: "settings", label: "设置", href: "/settings", icon: SettingsIcon },
];
...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-[260px] bg-white border-r border-gray-200 flex flex-col z-30">
      {/* Logo */}
      ...
      <div className="p-4 border-t border-gray-200">
        ...
        <p className="text-center text-xs text-gray-400 mt-2">已绑定</p>
      </div>
    </aside>
  );
}
